    ...
    private runStep(stepIndex: number) {
        ...
        switch (stepIndex) {
            ...
            case 1: // Horizontal Line
                ...
                this.updateText("Horizontal Lines", "Drag the block to clear the horizontal line.");
                break;
            ...
            case 4: // Game Over
                ...
                this.updateText("Game Over", "The game ends when you can't place any of your 3 blocks.");
                this.engine.setShapes([null, null, null]);
                break;
        }
    }
    
    private updateText(title: string, text: string) {
        this.titleEl.textContent = title;
        this.textEl.textContent = text;
    }

    // Called by GameApp when a move is made
